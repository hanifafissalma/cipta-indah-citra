        ...
        <LayoutDefault>
            ...
            >
                <div className="w-5/6 mx-auto">
                    <FadeInUp>
                        <h1 className="text-4xl font-bold drop-shadow-lg">Manajemen Konstruksi</h1>
                    </FadeInUp>
                    <FadeInUp delay=".4s">
                    ...
                    <div className="md:w-full lg:w-2/3 mx-auto mt-8 text-justify">
                        <FadeInUp>
                            <ol className="custom-list text-justify">
                                ...
                                <li>
                                    Informasi Acara (BA) Serah Terima Ke-1 : Laporan hasil uji mekanikal, 
                                    elektrikal, dan teknik lingkungan, serta laporan hasil finishing eksterior 
                                    dan interior serta lanskap.
                                </li>
                                <li>
                                    Laporan Akhir & Informasi Acara Serah Terima Ke-2 : Mencakup perbaikan cacat 
